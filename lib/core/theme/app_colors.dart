...
class AppColors {
  ...
  static Color darkOpacity3 = Colors.black.withOpacity(0.3);
  static Color lightOpacity1 = Colors.white.withOpacity(0.03);
  static Color lightOpacity2 = Colors.white.withOpacity(0.05);
  static Color lightOpacity3 = Colors.white.withOpacity(0.07);
